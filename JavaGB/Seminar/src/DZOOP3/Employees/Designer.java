...
public class Designer extends Employee {
    ...
    public Designer(String firstName, String surName, double salary) {
    ...
    public String toString() {
        return String.format("%s %s; Дизайнер; Заработная плата в час: %.2f рублей; Среднемесячная заработная плата: %.2f рублей.",
